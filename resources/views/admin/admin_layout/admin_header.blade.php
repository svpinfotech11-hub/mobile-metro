...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD89e_jQ_xoTxPKqwkks0Z0PbtPCNkHKaE&libraries=places"></script>
...
<body class="hold-transition sidebar-mini" style="text-transform: uppercase;font-family: math;font-size: 13px;">
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('app.admin-dashboard');}}" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
